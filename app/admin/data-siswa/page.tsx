      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-18 overflow-auto">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 mb-8">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-end justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-indigo-600 to-blue-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
              >
                    ...
                    {displayedSiswa(kelas).map((siswa, idx) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          {siswa.name} {/* Ganti userId ke name */}
                        </td>
                        <td className="px-6 py-4 text-gray-700">
                          {siswa.userId}
                        </td>
                        <td className="px-6 py-4 text-gray-700">{kelas}</td>
                        <td className="px-6 py-4 text-gray-700">
                          {siswa.tempatPKL || "-"}
                        </td>
                      </tr>
          ...
          {showModal && selectedSiswa && (
            <div
              className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              <table className="w-full table-auto border-collapse text-gray-800 mb-6">
                <tbody>
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="px-6 py-4">{selectedSiswa.name}</td>{" "}
                    {/* Ganti userId ke name */}
                  </tr>
                  <tr className="border-b border-gray-200">
                    <th className="px-6 py-4 text-left font-semibold">NIS</th>
                    <td className="px-6 py-4">{selectedSiswa.userId}</td>
                  </tr>
                  <tr className="border-b border-gray-200">
              ...
              <button
                ...
                className="px-6 py-3 bg-indigo-600 text-white rounded-xl shadow-lg hover:bg-indigo-700 transition transform hover:scale-105"
              >
                Edit Data
              </button>
            </div>
    ...
    >
      ...
      >
        ...
        <div className="md:col-span-2 flex justify-end gap-6 mt-4">
          <button
            type="submit"
            className="flex items-center gap-2 px-8 py-3 bg-linear-to-r from-indigo-600 to-blue-600 text-white rounded-xl shadow-lg hover:shadow-xl transition transform hover:scale-105"
          >
            <Users className="w-5 h-5" />
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex items-center gap-2 px-8 py-3 bg-gray-500 text-white rounded-xl shadow-inner hover:bg-gray-600 transition transform hover:scale-105"
          >
