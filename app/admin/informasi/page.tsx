                ...
                >
                  <div className="flex flex-col md:col-span-3">
                    ...
                    <input
                      ...
                      required
                      className="px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition w-full"
                    />
                  </div>
                  ...
                  <div className="flex flex-col md:col-span-2">
                    ...
                    <textarea
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition resize-none min-h-[150px]"
                    />
                  </div>
