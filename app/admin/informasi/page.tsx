        ...
        <main style={{ flex: 1, overflowY: "auto", padding: "28px 32px", background: "#f9fafb" }}>
          ...
          {loading && (
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxWidth: "768px" }}>
              {[1, 2, 3].map(i => (
                <div key={i} style={{ background: "white", borderRadius: "16px", padding: "20px", borderLeft: "4px solid #e5e7eb", border: "1px solid #e5e7eb" }}>
              ...
              {list.map(item => (
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", paddingLeft: "20px" }}>
                    ...
                    <div style={{ display: "flex", gap: "6px", flexShrink: 0, paddingRight: "4px" }} onClick={e => e.stopPropagation()}>
                      <button
                      ...
                      <button
                        ...
                        style={{ background: "transparent", border: "1px solid #e5e7eb", borderRadius: "8px", padding: "5px 12px", cursor: "pointer", color: "#ef4444", fontSize: "12px", fontWeight: 600 }}
                      >
                        Hapus
                      </button>
                    </div>
      ...
      {selected && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50, padding: "16px" }}
          ...
          <div style={{ background: "white", borderRadius: "20px", padding: "28px", maxWidth: "620px", width: "100%", maxHeight: "80vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", borderTop: "1px solid #f3f4f6", paddingTop: "20px" }}>
              ...
              <button onClick={() => handleDelete(selected.id)} style={{ background: "#fee2e2", color: "#dc2626", padding: "8px 20px", borderRadius: "9px", border: "none", cursor: "pointer", fontWeight: 600, fontSize: "13px" }}>
                Hapus
              </button>
