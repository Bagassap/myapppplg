                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", paddingLeft: "20px" }}>
                    ...
                    <div style={{ display: "flex", gap: "6px", flexShrink: 0, paddingRight: "4px" }} onClick={e => e.stopPropagation()}>
                      ...
                      <button
                        ...
                        style={{ background: "transparent", border: "1px solid var(--bd)", borderRadius: "8px", padding: "5px 12px", cursor: "pointer", color: "#ef4444", fontSize: "12px", fontWeight: 600 }}
                      >
                        Hapus
                      </button>
                    </div>
      ...
      {selected && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50, padding: "16px" }}
          ...
          <div style={{ background: "var(--surface)", borderRadius: "20px", padding: "28px", maxWidth: "620px", width: "100%", maxHeight: "80vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", borderTop: "1px solid var(--bd2)", paddingTop: "20px" }}>
