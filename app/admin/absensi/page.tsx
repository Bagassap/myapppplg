...
function FilterSelect({
  ...
  return (
    <select
      ...
      className="px-3 py-1.5 border border-slate-200 rounded-lg bg-slate-50 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-shadow"
    >
      {options.map((o) => (
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm px-4 py-3 mb-5 flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 border border-slate-200 rounded-lg bg-slate-50 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-300 w-[155px]"
              />
            </div>
