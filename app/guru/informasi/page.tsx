...
import { Plus, X, Pencil, Loader2, Megaphone } from "lucide-react";
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <h3 className="font-bold text-white text-[15px] leading-snug">{item.judul}</h3>
                          <div
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-[11px] font-bold text-gray-500 mb-2 uppercase tracking-wider">Konten</label>
                  <textarea
                    value={form.konten}
                    required
                    rows={7}
