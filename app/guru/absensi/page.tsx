...
export default function GuruAbsensi() {
  ...
  // Helper untuk keterangan otomatis
  ...
  // --- TABEL ROW UTAMA (RINGKAS + TOMBOL LIHAT) ---
  const renderTableRow = (item: {
    ...
    return (
      ...
      >
        ...
        <td className="px-8 py-5 text-gray-700 text-lg font-medium">
          {item.siswa}
        </td>
        ...
        <td className="px-8 py-5 text-gray-700 text-lg">
          <button
            ...
            className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors duration-200 flex items-center gap-2 text-lg"
          >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-18 overflow-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg">Lihat data absensi siswa</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-end">
              ...
              <div className="flex justify-start md:justify-end">
                <button
                  ...
                  className="flex items-center gap-3 px-8 py-4 bg-linear-to-r from-indigo-600 to-blue-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:from-indigo-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 text-lg"
                >
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl mb-10 border border-gray-200 hover:shadow-3xl transition-shadow duration-300">
            ...
            <div className="flex gap-6">
              <button
                ...
                className="flex items-center gap-3 px-8 py-4 bg-linear-to-r from-green-600 to-green-700 text-white rounded-xl shadow-lg hover:shadow-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 transform hover:scale-105 text-lg"
              >
              ...
              <button
                ...
                className="flex items-center gap-3 px-8 py-4 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-xl shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 text-lg"
              >
          ...
          {showSiswaPresensi && selectedSiswa && (
            <div className="fixed inset-0 flex items-center justify-center z-50">
              {/* Overlay background - DIBUAT IDENTIK DENGAN ABSEN HARIAN SISWA */}
              <div
              ...
              <div
                className="bg-white rounded-3xl shadow-2xl max-w-6xl w-full mx-4 p-10 animate-fade-scale transform-gpu transition duration-300 ease-out z-10 relative"
                role="dialog"
                aria-modal="true"
                ...
                <div className="overflow-x-auto max-h-[60vh] overflow-y-auto">
                  <table className="w-full table-auto border-collapse">
                    <thead className="sticky top-0 bg-white">
                      {/* TABLE HEADERS UNTUK MODAL (LENGKAP) */}
                      <tr className="bg-linear-to-r from-indigo-100 to-blue-100">
                        <th className="px-8 py-5 text-left font-semibold text-gray-700 rounded-tl-2xl text-lg">
                          Tanggal
                        </th>
                    ...
                    <tbody>
                      {/* TABLE ROWS UNTUK MODAL (LENGKAP) */}
