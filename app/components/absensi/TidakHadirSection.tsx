        ...
        <>
          {loading ? (
            ...
            <>
                ...
                <table className="w-full text-sm min-w-[480px]">
                  <thead>
                    <tr className="border-b border-gray-100 bg-gray-50 /50">
                      ...
                      {role === "admin" && (
                        <th className="px-5 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">
                          Guru Pembimbing
                        </th>
                      )}
                    </tr>
                  ...
                  <tbody className="divide-y divide-gray-100 ">
                    {currentData.map((siswa) => (
                      <tr
                        key={siswa.userId}
                        className="hover:bg-red-50/30 /10 transition-colors"
                      >
                        <td className="px-5 py-3">
                          <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 rounded-full bg-red-100 /40 text-red-600 text-xs font-bold flex items-center justify-center shrink-0">
                        ...
                        {role === "admin" && (
                          <td className="px-5 py-3 text-gray-500 text-sm hidden md:table-cell">
              ...
              {/* Pagination */}
              {totalPages > 1 && (
                <div className="px-5 py-3 border-t border-gray-100 bg-gray-50 /30 flex items-center justify-between gap-4">
                  <p className="text-xs text-gray-400 ">
                    {startIndex + 1}–
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="px-2 py-1.5 text-xs text-gray-600 font-semibold">
