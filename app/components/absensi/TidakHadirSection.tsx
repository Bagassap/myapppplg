...
export default function TidakHadirSection({ period, role }: Props) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden mt-6">
      {/* ── Header ── */}
      <div
        className="flex items-center justify-between px-5 py-4 border-b border-slate-100 cursor-pointer select-none"
              ...
              {totalPages > 1 && (
                <div className="px-5 py-3 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="px-2 py-1.5 text-xs text-slate-600 font-semibold">
