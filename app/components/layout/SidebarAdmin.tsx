...
export default function SidebarAdmin() {
  ...
  return (
    <aside
      className={`bg-linear-to-b from-indigo-700 via-indigo-600 to-blue-600 text-white flex flex-col justify-between shadow-2xl min-h-screen transition-all duration-300 ${
        isOpen ? "w-80" : "w-20"
      } rounded-r-2xl`}
    >
      {/* Header */}
